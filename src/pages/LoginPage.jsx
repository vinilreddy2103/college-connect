        ...
        try {
            ...
            if (user) {
                if (user.emailVerified) {
                    ...
                    // Standard user redirect (no admin checks here)
                    navigate('/dashboard');
                } else {
        ...
        <div className="flex items-center justify-center min-h-screen bg-slate-900">
            <div className="w-full max-w-md p-8 space-y-8 bg-slate-800 rounded-lg shadow-lg">
                ...
                <button 
                    ...
                    className="w-full flex items-center justify-center py-2.5 px-4 text-sm font-medium text-gray-200 bg-slate-700 rounded-lg hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-sky-500 transition-colors duration-200"
                >
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 text-gray-400 bg-slate-800">OR</span>
                    </div>
                </div>
